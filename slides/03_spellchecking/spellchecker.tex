...
\begin{frame}{A calculation example}
    ...
    \begin{columns}
        ...
        \begin{enumerate}
            ...
            \item \textcolor{purple!75}{False positives}: \visible<4->{\textcolor{purple!75}{10}}
            \item \textcolor{red!75}{False negatives}: \visible<5->{\textcolor{red!75}{30}}
        \end{enumerate}
    \end{columns}
